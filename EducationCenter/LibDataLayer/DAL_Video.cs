...
{
    public static class DalVideo
    {
        private static readonly SqlHelper Cls = new SqlHelper();
        #region[Get-Data]
        public static DataTable GetVideo(string keywords)
        {
            Cls.CreateNewSqlCommand();
            Cls.AddParameter("KEYWORDS", keywords);
            return Cls.GetData("sp_Video_Get");
        }
        public static DataTable GetVideoEdit(int id)
        {
            Cls.CreateNewSqlCommand();
            Cls.AddParameter("ID_Video", id);
            return Cls.GetData("sp_Video_Get_Edit");
        }
        public static DataTable GetVideoFillterStatus(int IsActive)
        {
            Cls.CreateNewSqlCommand();
            Cls.AddParameter("IsActive", IsActive);
            return Cls.GetData("sp_Video_Get_FillterStatus");
        }
        #endregion
        ...
        public static bool Insert(DTOVideo obj)
        {
            ...
            Cls.ExecuteNonQuery("sp_Video_Insert");
            return true;
        }
        public static bool Update(DTOVideo obj)
        {
            ...
            Cls.AddParameter("width", obj.width);
            Cls.AddParameter("height", obj.height);
            Cls.ExecuteNonQuery("sp_Video_Update");
            return true;
        }
        public static bool Delete(DTOVideo obj)
        {
            Cls.CreateNewSqlCommand();
            Cls.AddParameter("ID_Video", obj.ID_Video);
            Cls.ExecuteNonQuery("sp_Video_Delete");
            return true;
        }
        public static bool UpdateNum(DTOVideo obj)
        {
            ...
            Cls.AddParameter("ID_Video", obj.ID_Video);
            Cls.AddParameter("Num", obj.Num);
            Cls.ExecuteNonQuery("sp_Video_Update_Num");
            return true;
        }
        public static bool UpdateCheck(DTOVideo obj)
        {
            ...
            Cls.AddParameter("ID_Video", obj.ID_Video);
            Cls.AddParameter("IsActive", obj.IsActive);
            Cls.ExecuteNonQuery("sp_Video_Update_Check");
            return true;
        }
        #endregion

        #region[Get-Data-HomePage]
        public static DataTable GetVideoHomePage(string keywords)
        {
            Cls.CreateNewSqlCommand();
            Cls.AddParameter("KEYWORDS", keywords);
            return Cls.GetData("sp_Video_Get_HomePage");
        }
        #endregion
    }
