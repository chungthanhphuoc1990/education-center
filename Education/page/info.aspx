<%@ Page Title="" Language="C#" MasterPageFile="~/page/Home.master" AutoEventWireup="true" CodeFile="info.aspx.cs" Inherits="page_info" %>
            ...
            <div class="content-news">
                <div class="col-md-12">
                    <div class="titile-news">
                        ...
                        <p class="short-content-news">
                            Ngày 01 tháng 04 năm 2011 vừa qua ngoại ngữ Dương Minh tròn 21 tuổi. Như một đời người  cũng đã trải qua tuổi ấu thơ bé bỏng rồi đến tuổi thiếu niên đầy ước vọng và tuổi trưởng thành đầy sinh lực. Tháng 04 tới đây ngoại ngữ Dương Minh sẽ giã từ tuổi thiếu niên (tuổi teen) để vươn đến tuổi trưởng thành đầy sinh lực. Với tư cách một nhà giáo, tôi rất vui mừng vì đã góp phần tích cực cho sự nghiệp giáo dục tại thành phố chúng ta. Với tư cách người sáng lập tôi rất sung sướng chứng kiến sự lớn lên từng ngày của đứa con thân yêu mình tạo ra.
                            Trong tương lai ngoại ngữ Dương Minh sẽ tiếp tục nghiên cứu áp dụng các phương pháp dạy học tiên tiến trên thế giới cũng như các thiết bị khoa học kỹ thuật để có thể giúp người học đạt được những thành quả tối đa trong viêc học của họ.
                        </p>
                    </div>
                </div>
            </div>
