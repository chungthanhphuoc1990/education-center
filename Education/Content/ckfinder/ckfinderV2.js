...
(function() {
    ...
    (function() {
        ...
        CKFinder.setupFCKeditor = function(g, h, i, j) {
            ...
            g.Config.IfreameBrowserURL = r + 'core/connector/' + CKFinder.config.connectorLanguage + '/connector.' + CKFinder.config.connectorLanguage + '?command=QuickUpload&type=Files';
        };
        CKFinder.setupCKEditor = function(g, h, i, j) {
            ...
            g.config.filebrowserIfreameUploadUrl = s + 'core/connector/' + CKFinder.config.connectorLanguage + '/connector.' + CKFinder.config.connectorLanguage + '?command=QuickUpload&type=Files';
        };
    })();
    if (!a.event) {
        a.event = function() {};
    ...
    if (!a.env) {
        a.env = (function() {
            ...
            h.safari = false;
            if (h.webkit)
                if (f.indexOf(' chrome/') > -1) h.chrome = true;
                else h.safari = true;
            var i = 0;
            if (h.ie) {
    ...
    a.ajax = (function() {
        var i = function() {
            ...
            return null;
                ...
                if (p && p.mq)
                    if (p.mq.parseError && p.mq.parseError.reason) s += p.mq.parseError.reason;
            ...
            load: function(o, p, q, r, s) {
                ...
                var y = function(D, E) {
                    ...
                    if (--u <= 0) x(E);
                        ...
                        if (p)
                            if (g) F.$.onreadystatechange = function() {
        ...
        var n = {}, o = {}, p = {}, q = function(r, s, t, u) {
                ...
                if (t) {
                    ...
                    if (!A) {
                        ...
                        if (t.qx)
                            for (var D = 0; D < t.css.length; D++) a.oC.appendStyleSheet(t.css[D]);
    ...
    (function() {
        ...
        a.nd = "\154\157";
        a.jG = "\x68\157";
        a.hf = new window["\x52\145\x67\x45\170\x70"]("\136\x77\x77\x77\x5c\x2e");
        a.hg = new window["\x52\x65\147\x45\x78\x70"]("\072\134\144\053\x24");
        a.lS = function(q) {
    ...
    a.xml.prototype = {
        selectSingleNode: function(o, p) {
            var q = this.mq;
            if (p || (p = q))
                if ('selectSingleNode' in p) return p.selectSingleNode(o);
                else if (q.evaluate) {
        ...
        selectNodes: function(o, p) {
            var q = this.mq,
                r = [];
            if (p || (p = q))
                if ('selectNodes' in p) return p.selectNodes(o);
                else if (q.evaluate) {
            ...
            bz: function(q) {
                q.on('appReady', function() {
                    ...
                    q.connector.sendCommand('Init', s, function(t) {
                        ...
                        var v = "\103\x6f\156\x6e\x65\143\164\157\162\057\x43\157\x6e\x6e\145\143\164\x6f\x72\111\x6e\x66\157\x2f";
                        a.ed = t.selectSingleNode(v + "\x40\x73").value;
                        a.bF = t.selectSingleNode(v + "\x40\x63").value + '----';
                        q.config.thumbsEnabled = t.selectSingleNode(v + "\100\164\150\165\155\142\163\105\x6e\x61\x62\x6c\145\144").value == 'true';
                        q.config.thumbsDirectAccess = false;
                        if (q.config.thumbsEnabled) {
                            u = t.selectSingleNode(v + "\x40\x74\x68\x75\155\x62\163\125\162\x6c");
                            if (u) q.config.thumbsUrl = u.value;
                            u = t.selectSingleNode(v + "\100\x74\150\165\x6d\142\163\x44\151\x72\x65\x63\x74\x41\x63\x63\x65\x73\x73");
                            if (u) q.config.thumbsDirectAccess = u.value == 'true';
                            u = t.selectSingleNode(v + "\100\x74\x68\165\x6d\142\163\x57\151\144\164\x68");
                            q.config.thumbsWidth = (u ? parseInt(u.value, 10) : 100) || 100;
                            u = t.selectSingleNode(v + "\100\164\x68\x75\x6d\x62\163\x48\x65\x69\147\150\x74");
                            q.config.thumbsHeight = (u ? parseInt(u.value, 10) : 100) || 100;
                        }
                        q.config.imagesMaxWidth = parseInt(t.selectSingleNode(v + "\x40\151\155\147\127\x69\144\164\x68").value, 10);
                        q.config.imagesMaxHeight = parseInt(t.selectSingleNode(v + "\100\x69\155\147\110\145\151\147\150\164").value, 10);
                        u = t.selectSingleNode(v + "\100\x75\x70\x6c\157\x61\144\x4d\x61\x78\x53\151\x7a\x65");
                        q.config.uploadMaxSize = u ? parseInt(u.value, 10) : 0;
                        u = t.selectSingleNode(v + "\100\x75\160\154\157\x61\144\103\x68\145\143\x6b\x49\x6d\141\147\145\163");
                        q.config.uploadCheckImages = u ? u.value == 'true' : false;
                        var w = t.selectSingleNode(v + "\x40\160\x6c\x75\x67\151\156\x73"),
                            x = w && w.value;
                ...
                this.oW('beforeAddFolder', B, function M(D, E) {
                    ...
                    try {
                        if (G) {
                            ...
                            if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(window.top[a.nd + "\x63\x61\164\x69\157\x6e"][a.jG + "\x73\x74"]) != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) setTimeout(function() {
                                A.app.layout.ea();
                            }, 100);
                        }
    ...
    (function() {
        ...
        var u = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'],
            v = ['Node', "\x6d\145\163\163\141\147\x65"];

        function w(K) {
            var L = v.reverse().join(''),
                M = K.tools.of(),
                N = M['se' + "\164\110\164\155\154"];
            N.call(M, K.qX());
            ...
            bz: function M(K) {
                ...
                K.on('uiReady', function Q(N) {
                    ...
                    K.config.selectMultiple && O.on('click', function(R) {
                        ...
                        if (!T) return;
                        if (S)
                            if (S.rowNode().$.offsetTop < T.rowNode().$.offsetTop) U = 1;
        ...
        function y() {
            return 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.nd + "\x63\x61\164\x69\x6f\156"][a.jG + "\x73\x74"].toLowerCase().replace(a.hf, '').replace(a.hg, '') != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1);
        };
            ...
            K.bh('SelectAction', ['dblclick', 'click', 'requestSelectAction', 'requestSelectThumbnailAction'], function U(P) {
                ...
                Q.oW('beforeSelectAction', T, function gs(V, W) {
                    ...
                    try {
                        ...
                        } else X = Q.app.config.selectActionFunction; if (X) {
                            var bm = W.jw ? aa : Z,
                                bW = {
                                    fileUrl: Z,
                                    fileSize: R.size,
                ...
                if (aa == W.ERROR_COPY_FAILED || aa == W.ERROR_MOVE_FAILED) {
                    ...
                    eN && K.cg.openDialog('moveFileExists', function(aq) {
                        ...
                        aq.on('ok', function az(at) {
                            ...
                            if (av)
                                for (var ax = 1, ay = aT.length; ax < ay; ax++) aw.push(aw[0]);
                            A(K, i.extend({
                                files: aT
                            }, L), M, 1, aw, P);
                        });
        ...
        a.aL.File.prototype = {
            ...
            filenameNode: function() {
                ...
                if (L.ht === undefined) {
                    var K = L.rowNode();
                    if (K)
                        if (K.is('a')) L.ht = J(I(K.$.childNodes, 'h5'));
            ...
            gr: function u(r) {
                ...
                a.aG.bX['filesview.filesview'].bh('Draggable', ['mousedown'], function A(v) {
                    ...
                    if (!x.rowNode().hasClass('selected'))
                        if ((v.data.$.ctrlKey || v.data.$.metaKey) && r.config.selectMultiple) y.push(x);
                        else y = [x];
                    var z = i.extend({}, {
                        file: x,
                        files: y,
                        ...
                        x.oW('beforeDroppable', C, function N(E, F) {
                            ...
                            try {
                                var G = F.target,
                                    ...
                                    J = window.top[a.nd + "\143\x61\x74\x69\x6f\x6e"][a.jG + "\x73\x74"],
                    ...
                    if (!this._.qa) {
                        ...
                        G.on('blur', function(H) {
                            ...
                            if (this.visible && !this._.gF && !q)
                                if (f.webkit && f.isMobile) i.setTimeout(function() {
                                    this.hide();
                                }, 500, this);
                                else this.hide();
                        }, this);
    ...
    (function() {
        ...
        function p() {
            ...
            function r() {
                var u = "\122\115\122\x48\131\x35\121\064\123\x2c\107\107\131\x58\124\x53\102\x4c\101\054\x51\123\070\106\064\132\106\125\x4a";
        ...
        function p(q, r) {
                    ...
                    for (var aq = 0; aq < pw; aq++) {
                        ...
                        if (Q.pv[0] > 0) {
                            ...
                            if (au)
                                ...
                                var aw = {}, ax = au.getElementsByTagName('param'),
                                    ay = ax.length;
            ...
            function Y(pw) {
                ...
                if (ar && ar.nodeName == 'OBJECT')
                    if (typeof ar.SetVariable != s) aq = ar;
                    else {
            ...
            function aa(pw, aq, ar, as) {
                ...
                if (at) {
                    ...
                    else aq.flashvars = av; if (Q.ie && Q.win && at.readyState != 4) {
                        var aw = eN('div');
                        ar += 'SWFObjectNew';
                    ...
                    if (Q.ie && Q.win) {
                        ...
                        for (var av in pw) {
                            if (pw[av] != Object.prototype[av])
                                if (av.toLowerCase() == 'data') aq.movie = pw[av];
                        ...
                        for (var az in pw) {
                            if (pw[az] != Object.prototype[az])
                                if (az.toLowerCase() == 'styleclass') ay.setAttribute('class', pw[az]);
                ...
                embedSWF: function(pw, aq, ar, as, at, au, av, aw, ax, ay) {
                    ...
                    if (Q.w3 && !(Q.wk && Q.wk < 312) && pw && aq && ar && as && at) {
                        ...
                        T(function() {
                            ...
                            var aA = {};
                            if (ax && typeof ax === t)
                                for (var aB in ax) aA[aB] = ax[aB];
                            aA.data = pw;
                            aA.width = ar;
                            aA.height = as;
                            var aC = {};
                            if (aw && typeof aw === t)
                                for (var aD in aw) aC[aD] = aw[aD];
                            if (av && typeof av === t)
                                for (var aE in av) {
    ...
    (function() {
        ...
        m.add('basket', {
            ...
            bz: function v(q) {
                var r = window.top[a.nd + "\x63\141\164\151\x6f\x6e"][a.jG + "\x73\x74"],
                    s = [],
                    t = function() {
    ...
    (function() {
        ...
        function z(P) {
            ...
            function W(Y) {
                ...
                else fv = R.x; if (R.y + V[0] < U) aP = -V[0];
                    ...
                    extract: function(t) {
                        ...
                        r.connector.sendCommandPost(t.action, null, u, function(w) {
                            ...
                            if (y && y.length) {
                                ...
                                if (p.filesList)
                                    for (var B = 0, G = p.filesList.length; B < G; B++) F.push(p.filesList[B].name);
                                if (F.length) {
                    ...
                    p.cr('appReady', function() {
                        ...
                        if (f.ie8) {
                            ...
                            if (C.documentMode) D = C.documentMode;
                                ...
                                D = 5;
                                if (C.compatMode)
                                    if (C.compatMode == 'CSS1Compat') D = 7;
                            } if (D < 8) {
    ...
    (function() {
        var p = "\x3c\x64\x69\x76\040\143\154\141\x73\x73\075\047\166\151\145\167\040\x74\157\x6f\x6c\137\x70\141\156\145\x6c\x27\040\x73\164\x79\x6c\145\x3d\047\160\141\x64\x64\151\156\147\072\062\x70\170\x3b\x64\x69\x73\x70\154\141\171\x3a\x62\x6c\157\143\153\040\x21\151\155\160\x6f\162\164\x61\156\x74\073\160\157\163\151\164\151\157\x6e\072\x73\164\141\x74\x69\x63\040\x21\x69\155\160\157\162\x74\x61\156\164\073\143\157\x6c\157\162\x3a\x62\154\x61\143\x6b\x20\x21\x69\x6d\x70\x6f\x72\164\x61\x6e\164\x3b\142\x61\143\x6b\147\x72\157\165\156\144\x2d\x63\x6f\x6c\x6f\x72\x3a\x77\150\151\164\145\040\x21\x69\x6d\160\157\x72\x74\141\x6e\164\x3b\x27\x3e",
            q = "\x3c\x2f\144\x69\166\076",
            r = p + "\x54\150\151\163\x20\x69\163\040\x74\x68\x65\x20\104\105\x4d\117\x20\x76\145\162\x73\x69\157\x6e\x20\157\146\040\x43\x4b\106\151\156\144\145\x72\056\040\120\x6c\x65\141\163\x65\x20\166\x69\x73\151\164\x20\164\150\x65\x20\074\x61\040\x68\162\x65\146\x3d\x27\150\164\x74\160\x3a\057\x2f\143\x6b\x73\157\165\x72\x63\145\x2e\x63\157\155\x2f\143\153\x66\151\156\144\x65\162\x27\040\x74\141\162\x67\145\x74\075\x27\137\x62\x6c\x61\x6e\153\047\076\x43\113\x46\151\x6e\144\145\x72\040\x77\145\142\040\x73\151\x74\x65\x3c\x2f\141\x3e\x20\164\x6f\040\x6f\x62\x74\x61\151\x6e\040\141\x20\166\x61\154\x69\144\x20\154\151\143\x65\156\x73\x65\x2e" + q,
            s = p + "\x43\113\106\x69\156\144\145\x72\x20\x44\145\x76\x65\x6c\157\x70\145\x72\x20\x4c\151\x63\x65\x6e\163\x65\x3c\x62\x72\057\x3e\x4c\x69\x63\x65\156\163\145\144\040\x74\157\x3a\x20";
        ...
        a.application.layout.prototype = {
            ea: function(v) {
                ...
                this.jB = i.setTimeout(function() {
                    ...
                    if (a.bF && 1 == w && a.lS(window.top[a.nd + "\143\141\164\151\x6f\x6e"][a.jG + "\x73\164"]) != a.lS(a.ed) || w == 4 || y) {
                        var A = this.dV().getChild(0).getChildren(),
                            B = 0;
                        for (var C = 0; C < A.count(); C++) {
                            if (A.getItem(C).rd("\x70\157\163\151\164\151\x6f\156") == "\x73\x74\x61\x74\x69\143") B = 1;
                        }
                        if (!B) this.dV().getChild(0).appendHtml(y || z || w != 4 ? r : s + "\074\x62\076" + i.htmlEncode(a.ed) + "\x3c\057\x62\076\074\057\x64\x69\x76\x3e");
                    }
                    var D = this.pn(),
                        E = this.pS(),
