<%@ page title="Quản lý trang" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_Page, App_Web_j5ubxec3" %>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <b>Tiêu đề : </b><asp:Label ID="lb_lst_titile_vn" runat="server" Text='<%# Eval("Page_Titile_Vn") %>'></asp:Label><br/>
                                        <b>Url : </b><asp:Label ID="lb_lst_friendly_url_vn" runat="server" Text='<%# Eval("Friendly_Url_Vn") %>'></asp:Label><br/>
                                        <b>Đường dẫn : </b><asp:Label ID="lb_lst_path" runat="server" Text='<%# Eval("Url") %>'></asp:Label><br/>
                                        <b>ID: </b><asp:Label ID="lb_lst_ID" runat="server" Text='<%# Eval("ID_Page") %>'></asp:Label>
                                        <input type="hidden" id="hiddenId" value='<%# Eval("ID_Page") %>' runat="server" name="hiddenId" />
                                    </td>
                                    
                                    <td style="vertical-align:middle;">
                                        <b>Tiêu đề : </b> <asp:Label ID="lb_lst_titile_en" runat="server" Text='<%# Eval("Page_Titile_En") %>'></asp:Label><br/>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-header-background">
                ...
                <h4 class="modal-title modal-titile">Cập nhật trang</h4>
            </div>
