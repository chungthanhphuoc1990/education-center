<%@ page title="Tiện ích" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_Utilities_Detail, App_Web_51nukgau" %>
...
<asp:UpdatePanel ID="UpdatePanelGrid" runat="server">
                ...
                <div class="panel-body">
                    <div class="col-md-6" style="margin-top: 8px">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="drUtilitiesFillter" CssClass="form-control" runat="server" AutoPostBack="True" AppendDataBoundItems="True" OnSelectedIndexChanged ="drUtilitiesFillter_Change">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        ...
                                        <b>Thuộc : </b><asp:Label ID="Label4" runat="server" Text='<%# Eval("UtilitiesOfTitile_Vn") %>'></asp:Label><br/>
                                    ...
                                    <td style="vertical-align:middle;">
                                        ...
                                        <b>Thuộc : </b><asp:Label ID="Label5" runat="server" Text='<%# Eval("UtilitiesOfTitile_En") %>'></asp:Label><br/>
    ...
    <Triggers>
        ...
        <asp:AsyncPostBackTrigger ControlID="drUtilitiesFillter" EventName="SelectedIndexChanged"/>
...
<div class="modal fade modal-width-homepage" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-content">
        <div class="modal-header modal-header-background">
            ...
            <h4 class="modal-title modal-titile">Cập nhật tiện ích</h4>
        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                               <label class="control-label">Chọn nhóm thông báo</label>
                                <asp:DropDownList ID="drUtilities" CssClass="form-control" runat="server" AutoPostBack="True" AppendDataBoundItems="True">
