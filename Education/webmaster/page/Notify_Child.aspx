<%@ page title="Thông Báo" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_Notify_Child, App_Web_51nukgau" %>
        ...
        <ContentTemplate>
            ...
            <div class="table-responsive" style="margin-top: 8px">
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <asp:ListView ID="ListViewAll" runat="server" DataKeyNames="ID_Notify" ItemPlaceholderID="lstViewAll" OnItemCommand="ListViewAll_ItemCommand" OnItemDataBound="ListViewAll_ItemDataBound">
                        <ItemTemplate>
                            <tbody>
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        ...
                                        <b>Thuộc : </b><asp:Label ID="Label4" runat="server" Text='<%# Eval("Page_Titile_Vn") %>'></asp:Label><br/>
                                        <b>Url : </b><asp:Label ID="lb_lst_friendly_url_vn" runat="server" Text='<%# Eval("Friendly_Url_Vn") %>'></asp:Label>
                                        <input type="hidden" id="hiddenId" value='<%# Eval("ID_Notify") %>' runat="server" name="hiddenId" />
                                    </td>
                                    
                                    <td style="vertical-align:middle;">
                                        <b>Tiêu đề : </b> <asp:Label ID="lb_lst_titile_en" runat="server" Text='<%# Eval("Notify_Titile_En") %>'></asp:Label><br/>
                                        <b>Thuộc : </b><asp:Label ID="Label5" runat="server" Text='<%# Eval("Page_Titile_En") %>'></asp:Label><br/>
