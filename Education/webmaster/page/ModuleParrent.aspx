<%@ page title="" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_ModuleParrent, App_Web_51nukgau" %>
        ...
        <ContentTemplate>
                ...
                <div class="panel-body">
                    <div class="col-md-6" style="margin-top: 8px">
                        <div class="form-group">
                            <label class="control-label" style="text-align:left">Lọc theo Module</label>
            ...
            <div class="table-responsive" style="margin-top: 8px">
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <asp:ListView ID="ListViewAll" runat="server" DataKeyNames="Module_Parrent_ID" ItemPlaceholderID="lstViewAll" OnItemCommand="ListViewAll_ItemCommand" OnItemDataBound="ListViewAll_ItemDataBound">
                        <ItemTemplate>
                            <tbody>
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <b>Tiêu đề : </b><asp:Label ID="lb_lst_titile_vn" runat="server" Text='<%# Eval("Module_Parrent_Name") %>'></asp:Label><br/>
                                        <b>Mã module : </b><asp:Label ID="lb_lst_code" runat="server" Text='<%# Eval("Module_Parrent_Code") %>'></asp:Label><br/>
                                        <b>Thuộc : </b><asp:Label ID="lb_lst_modulemain" runat="server" Text='<%# Eval("Module_Main_Name") %>'></asp:Label><br/>
                                        <b>Url : </b><asp:Label ID="lb_lst_url" runat="server" Text='<%# Eval("Url") %>'></asp:Label>
                                        <input type="hidden" id="hiddenId" value='<%# Eval("Module_Parrent_ID") %>' runat="server" name="hiddenId" />
                                    </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-header-background">
                ...
                <h4 class="modal-title modal-titile">Cập nhật Module</h4>
            </div>
                        ...
                        <asp:Label ID="lbID" runat="server" Text="" Visible="False"></asp:Label>
                            <div class="col-md-12" style="margin-top: 8px">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="drModuleMain" CssClass="form-control" runat="server" AutoPostBack="True" AppendDataBoundItems="True" OnSelectedIndexChanged ="drStatus_Change">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">Mã module</label>
