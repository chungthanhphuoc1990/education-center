<%@ page title="Video" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_Video_Child, App_Web_51nukgau" %>
                ...
                <div class="panel-body">
                    <div class="col-md-6" style="margin-top: 8px">
                        <div class="form-group">
                            <label class="control-label" style="text-align:left">Lọc theo trang</label>
                            <asp:DropDownList ID="drPageFillter" CssClass="form-control" runat="server" AutoPostBack="True" AppendDataBoundItems="True" OnSelectedIndexChanged ="drPageFillter_Change">
                                <asp:ListItem Value="-1">--Chọn trang--</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-6" style="margin-top: 8px">
                ...
                <table class="table table-striped table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center;vertical-align:middle;width: 20%">Tiêu đề tiếng Việt</th>
                            <th style="text-align: center;vertical-align:middle;width: 20%">Tiêu đề tiếng Anh</th>
                            <th style="text-align: center;vertical-align:middle;width: 15%">Video</th>
                    ...
                    <asp:ListView ID="ListViewAll" runat="server" DataKeyNames="ID_Video" ItemPlaceholderID="lstViewAll" OnItemCommand="ListViewAll_ItemCommand" OnItemDataBound="ListViewAll_ItemDataBound">
                        <ItemTemplate>
                            <tbody>
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <b>Tiêu đề : </b><asp:Label ID="lb_lst_titile_vn" runat="server" Text='<%# Eval("Video_Titile_Vn") %>'></asp:Label><br/>
                                        <b>Thuộc : </b><asp:Label ID="lb_lst_page" runat="server" Text='<%# Eval("Page_Titile_Vn") %>'></asp:Label><br/>
                                        <b>Url : </b><asp:Label ID="lb_lst_friendly_url_vn" runat="server" Text='<%# Eval("Friendly_Url_Vn") %>'></asp:Label><br/>
                                        <b>Đường dẫn : </b><asp:Label ID="lb_lst_path" runat="server" Text='<%# Eval("Url") %>'></asp:Label>
                                        <input type="hidden" id="hiddenId" value='<%# Eval("ID_Video") %>' runat="server" name="hiddenId" />
                                    </td>
                                    
                                    <td style="vertical-align:middle;">
                                        <b>Tiêu đề : </b> <asp:Label ID="lb_lst_titile_en" runat="server" Text='<%# Eval("Video_Titile_En") %>'></asp:Label><br/>
                                        <b>Thuộc : </b><asp:Label ID="lb_lst_page_en" runat="server" Text='<%# Eval("Page_Titile_En") %>'></asp:Label><br/>
                                        <b>Url : </b> <asp:Label ID="lb_lst_Friendly_Url_En" runat="server" Text='<%# Eval("Friendly_Url_En") %>'></asp:Label>
                                    </td>
                                    
                                    <td style="vertical-align:middle;text-align: center">
                                        <iframe width="290" height="300" src="//<%# Eval("Url") %>" frameborder="0" allowfullscreen></iframe>
                                    </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-header-background">
                ...
                <h4 class="modal-title modal-titile">Cập nhật video</h4>
            </div>
                ...
                <asp:UpdatePanel ID="UpdatePanelUser" runat="server">
                    <ContentTemplate>
                        <asp:Label ID="lbID" runat="server" Text="" Visible="False"></asp:Label>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" style="text-align:left">Chọn trang</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">Url(nếu có)</label>
                            ...
                            <input class="form-control" id="txtID_Notify" type="hidden" runat="server"/>
