<%@ page title="Quảng cáo" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_Adv, App_Web_51nukgau" %>
        ...
        <ContentTemplate>
            ...
            <div class="table-responsive" style="margin-top: 8px">
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <asp:ListView ID="ListViewAll" runat="server" DataKeyNames="ID_Adv" ItemPlaceholderID="lstViewAll" OnItemCommand="ListViewAll_ItemCommand" OnItemDataBound="ListViewAll_ItemDataBound">
                        <ItemTemplate>
                            <tbody>
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <b>Tiêu đề : </b><asp:Label ID="lb_lst_titile_vn" runat="server" Text='<%# Eval("Adv_Titile_Vn") %>'></asp:Label><br/>
                                        ...
                                        <input type="hidden" id="hiddenId" value='<%# Eval("ID_Adv") %>' runat="server" name="hiddenId" />
                                    </td>
                                    
                                    <td style="vertical-align:middle;">
                                        <b>Tiêu đề : </b> <asp:Label ID="lb_lst_titile_en" runat="server" Text='<%# Eval("Adv_Titile_En") %>'></asp:Label><br/>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-header-background">
                ...
                <h4 class="modal-title modal-titile">Cập nhật quảng cáo</h4>
            </div>
