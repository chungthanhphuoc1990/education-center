<%@ page title="Wiget" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_Gallery_Detail, App_Web_wlb4l3rd" %>
...
<asp:UpdatePanel ID="UpdatePanelGrid" runat="server">
                ...
                <div class="panel-body">
                    <div class="col-md-6" style="margin-top: 8px">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="drGalleryFillter" CssClass="form-control" runat="server" AutoPostBack="True" AppendDataBoundItems="True" OnSelectedIndexChanged ="drGalleryFillter_Change">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <b>Tiêu đề : </b><asp:Label ID="lb_lst_titile_vn" runat="server" Text='<%# Eval("Gallery_Titile_Vn") %>'></asp:Label><br/>
                                        <b>Thuộc : </b><asp:Label ID="Label4" runat="server" Text='<%# Eval("GalleryOfTitile_Vn") %>'></asp:Label><br/>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <b>Tiêu đề : </b> <asp:Label ID="lb_lst_titile_en" runat="server" Text='<%# Eval("Gallery_Titile_En") %>'></asp:Label><br/>
                                        <b>Thuộc : </b><asp:Label ID="Label5" runat="server" Text='<%# Eval("GalleryOfTitile_En") %>'></asp:Label><br/>
    ...
    <Triggers>
        ...
        <asp:AsyncPostBackTrigger ControlID="drGalleryFillter" EventName="SelectedIndexChanged"/>
...
<div class="modal fade modal-width-homepage" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-content">
        <div class="modal-header modal-header-background">
            ...
            <h4 class="modal-title modal-titile">Cập nhật hình ảnh</h4>
        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                               <label class="control-label">Chọn nhóm thông báo</label>
                                <asp:DropDownList ID="drGallery" CssClass="form-control" runat="server" AutoPostBack="True" AppendDataBoundItems="True">
