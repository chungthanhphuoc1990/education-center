<%@ page title="Module Main" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_ModuleMain, App_Web_j5ubxec3" %>
        ...
        <ContentTemplate>
            ...
            <div class="table-responsive" style="margin-top: 8px">
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <asp:ListView ID="ListViewAll" runat="server" DataKeyNames="Module_Main_ID" ItemPlaceholderID="lstViewAll" OnItemCommand="ListViewAll_ItemCommand" OnItemDataBound="ListViewAll_ItemDataBound">
                        <ItemTemplate>
                            <tbody>
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <b>Tiêu đề : </b><asp:Label ID="lb_lst_titile_vn" runat="server" Text='<%# Eval("Module_Main_Name") %>'></asp:Label><br/>
                                        <b>Mã module : </b><asp:Label ID="lb_lst_code" runat="server" Text='<%# Eval("Module_Main_Code") %>'></asp:Label><br/>
                                        <input type="hidden" id="hiddenId" value='<%# Eval("Module_Main_ID") %>' runat="server" name="hiddenId" />
                                    </td>
