<%@ page title="Người dùng" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_User, App_Web_j5ubxec3" %>
...
<asp:UpdatePanel ID="UpdatePanelGrid" runat="server">
                ...
                <div class="panel-body">
                    <div class="col-md-6" style="margin-top: 8px">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="drGorupUserFillter" CssClass="form-control" runat="server" AutoPostBack="True" AppendDataBoundItems="True" OnSelectedIndexChanged ="drGorupUserFillter_Change">
                                <asp:ListItem Value="-1">--Chọn nhóm--</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-6" style="margin-top: 8px">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="drStatus" CssClass="form-control" runat="server" AutoPostBack="True" AppendDataBoundItems="True" OnSelectedIndexChanged ="drStatus_Change">
                                ...
                                <asp:ListItem Value="0">Mở khoá</asp:ListItem>
                                <asp:ListItem Value="1">Khoá</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-12">
                ...
                <table class="table table-striped table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center;vertical-align:middle;width: 20%">Tên người dùng</th>
                    ...
                    <asp:ListView ID="ListViewAll" runat="server" DataKeyNames="Login_Id" ItemPlaceholderID="lstViewAll" OnItemCommand="ListViewAll_ItemCommand" OnItemDataBound="ListViewAll_ItemDataBound">
                        <ItemTemplate>
                            <tbody>
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <b>Tên người dùng : </b><asp:Label ID="lb_lst_titile_vn" runat="server" Text='<%# Eval("UserName") %>'></asp:Label><br/>
                                        <b>Thuộc nhóm : </b><asp:Label ID="lb_lst_code" runat="server" Text='<%# Eval("Group_Name") %>'></asp:Label><br/>
                                        <input type="hidden" id="hiddenId" value='<%# Eval("Login_Id") %>' runat="server" name="hiddenId" />
                                    </td>
    ...
    <Triggers>
        ...
        <asp:AsyncPostBackTrigger ControlID="drGorupUserFillter" EventName="SelectedIndexChanged"/>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-header-background">
                ...
                <h4 class="modal-title modal-titile">Cập nhật người dùng</h4>
            </div>
                ...
                <asp:UpdatePanel ID="UpdatePanelUser" runat="server">
                    <ContentTemplate>
                        <asp:Label ID="lbID" runat="server" Text="" Visible="False"></asp:Label>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label" style="text-align:left">Chọn nhóm người dùng</label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label" id="lbPasswords" runat="server">Mật khẩu</label>
                                    <input type="password" class="form-control" id="txtPasswords" runat="server"/>
                                </div>
                            </div>
