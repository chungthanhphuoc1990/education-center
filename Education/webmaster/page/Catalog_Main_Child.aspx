<%@ page title="Trình đơn chính" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_Catalog_Main_Child, App_Web_j5ubxec3" %>
        ...
        <ContentTemplate>
            ...
            <div class="table-responsive" style="margin-top: 8px">
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <asp:ListView ID="ListViewAll" runat="server" DataKeyNames="ID_CatMain" ItemPlaceholderID="lstViewAll" OnItemCommand="ListViewAll_ItemCommand" OnItemDataBound="ListViewAll_ItemDataBound">
                        <ItemTemplate>
                            <tbody>
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <b>Tiêu đề : </b><asp:Label ID="lb_lst_titile_vn" runat="server" Text='<%# Eval("Catalog_Main_Titile_Vn") %>'></asp:Label><br/>
                                        <b>Thuộc : </b><asp:Label ID="lb_lst_page_vn" runat="server" Text='<%# Eval("Page_Titile_Vn") %>'></asp:Label><br/>
                                        <b>Url : </b><asp:Label ID="lb_lst_friendly_url_vn" runat="server" Text='<%# Eval("Friendly_Url_Vn") %>'></asp:Label>
                                        <input type="hidden" id="hiddenId" value='<%# Eval("ID_CatMain") %>' runat="server" name="hiddenId" />
                                    </td>
                                    
                                    <td style="vertical-align:middle;">
                                        <b>Tiêu đề : </b> <asp:Label ID="lb_lst_titile_en" runat="server" Text='<%# Eval("Catalog_Main_Titile_En") %>'></asp:Label><br/>
...
<div class="modal fade modal-width-homepage" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-content">
        <div class="modal-header modal-header-background">
            ...
            <h4 class="modal-title modal-titile">Cập nhật trình đơn con</h4>
        </div>
