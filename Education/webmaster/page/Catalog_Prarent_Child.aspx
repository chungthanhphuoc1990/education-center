<%@ page title="" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_Catalog_Prarent_Child, App_Web_wlb4l3rd" %>
            ...
            <asp:UpdatePanel ID="UpdatePanelUser" runat="server">
                <ContentTemplate>
                    <asp:Label ID="lbID" runat="server" Text="" Visible="False"></asp:Label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                               <label class="control-label">Chọn danh mục chính</label>
                                <asp:DropDownList ID="drCatalogParrent" CssClass="form-control" runat="server" AutoPostBack="True" AppendDataBoundItems="True">
                                    <asp:ListItem Value="=-1">--Chọn--</asp:ListItem>
                                </asp:DropDownList> 
                            </div>
                        </div>
