<%@ page title="Trình đơn con" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_Catalog_Prarent, App_Web_j5ubxec3" %>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <b>Tiêu đề : </b><asp:Label ID="lb_lst_titile_vn" runat="server" Text='<%# Eval("Catalog_Prarent_Titile_Vn") %>'></asp:Label><br/>
                                        <b>Thuộc : </b><asp:Label ID="Label4" runat="server" Text='<%# Eval("Catalog_Main_Titile_Vn") %>'></asp:Label><br/>
                                        <b>Url : </b><asp:Label ID="lb_lst_friendly_url_vn" runat="server" Text='<%# Eval("Friendly_Url_Vn") %>'></asp:Label>
                                        <input type="hidden" id="hiddenId" value='<%# Eval("ID_CatPrarent") %>' runat="server" name="hiddenId" />
                                    </td>
                                    
                                    <td style="vertical-align:middle;">
                                        <b>Tiêu đề : </b> <asp:Label ID="lb_lst_titile_en" runat="server" Text='<%# Eval("Catalog_Prarent_Titile_En") %>'></asp:Label><br/>
                                        <b>Thuộc : </b><asp:Label ID="Label5" runat="server" Text='<%# Eval("Catalog_Main_Titile_En") %>'></asp:Label><br/>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                               <label class="control-label">Chọn trình đơn chính</label>
                                <asp:DropDownList ID="drCatalogMain" CssClass="form-control" runat="server" AutoPostBack="True" AppendDataBoundItems="True">
