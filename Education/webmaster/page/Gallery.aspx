<%@ page title="Wiget" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_Gallery, App_Web_j5ubxec3" %>
        ...
        <ContentTemplate>
            ...
            <div class="table-responsive" style="margin-top: 8px">
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <asp:ListView ID="ListViewAll" runat="server" DataKeyNames="ID_Gallery" ItemPlaceholderID="lstViewAll" OnItemCommand="ListViewAll_ItemCommand" OnItemDataBound="ListViewAll_ItemDataBound">
                        <ItemTemplate>
                            <tbody>
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        ...
                                        <input type="hidden" id="hiddenId" value='<%# Eval("ID_Gallery") %>' runat="server" name="hiddenId" />
                                    </td>
                ...
                <asp:UpdatePanel ID="UpdatePanelUser" runat="server">
                    <ContentTemplate>
                        <asp:Label ID="lbID" runat="server" Text="" Visible="False"></asp:Label>
                            ...
                            <input class="form-control" id="txtID_Gallery" type="hidden" runat="server"/>
