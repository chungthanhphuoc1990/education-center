<%@ page title="" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_Intro, App_Web_j5ubxec3" %>
        ...
        <ContentTemplate>
            ...
            <div class="table-responsive" style="margin-top: 8px">
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <asp:ListView ID="ListViewAll" runat="server" DataKeyNames="ID_Intro" ItemPlaceholderID="lstViewAll" OnItemCommand="ListViewAll_ItemCommand" OnItemDataBound="ListViewAll_ItemDataBound">
                        <ItemTemplate>
                            <tbody>
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        ...
                                        <input type="hidden" id="hiddenId" value='<%# Eval("ID_Intro") %>' runat="server" name="hiddenId" />
                                    </td>
...
<div class="modal fade modal-width-homepage" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-content">
        <div class="modal-header modal-header-background">
            ...
            <h4 class="modal-title modal-titile">Cập nhật giới thiệu trang</h4>
        </div>
                    ...
                    <asp:Label ID="lbID" runat="server" Text="" Visible="False"></asp:Label>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="drPosition" runat="server" CssClass="form-control" AutoPostBack="True" AppendDataBoundItems="True">
                                    <asp:ListItem Value="-1">--Chọn--</asp:ListItem>
                                    <asp:ListItem Value="center">Giữa trang</asp:ListItem>
                                    <asp:ListItem Value="left">Bên trái trang</asp:ListItem>
                                    <asp:ListItem Value="right">Bên phải trang</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-md-4">
