<%@ page title="Tin tức" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_News_Child, App_Web_51nukgau" %>
            ...
            <div class="panel-body">
                ...
                <div class="col-md-4" style="margin-top: 8px">
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="drCatalogSubFillter" CssClass="form-control" runat="server" AutoPostBack="True" AppendDataBoundItems="True" OnSelectedIndexChanged ="drCatalogSubFillter_Change">
                            <asp:ListItem Value="-1">--Chọn danh mục con--</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col-md-4" style="margin-top: 8px">
                    ...
                    <asp:Label ID="lbID" runat="server" Text="" Visible="False"></asp:Label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                               <label class="control-label">Chọn trình đơn chính</label>
                                <asp:DropDownList ID="drCatalogParrent" CssClass="form-control" runat="server" AutoPostBack="True" AppendDataBoundItems="True" OnSelectedIndexChanged="drCatalogParrent_Change">
                                    <asp:ListItem Value="-1">--Chọn--</asp:ListItem>
                                </asp:DropDownList> 
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                               <label class="control-label">Chọn trình đơn con</label>
                                <asp:DropDownList ID="drCatalogSub" CssClass="form-control" runat="server" AutoPostBack="True" AppendDataBoundItems="True" OnSelectedIndexChanged="drCatalogSub_Change">
                                    <asp:ListItem Value="-1">--Chọn--</asp:ListItem>
                                </asp:DropDownList> 
                            </div>
                        </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    ...
                                    <input id="Button3" class="btn btn-default" type="button" value="Xem ảnh" runat="server" onserverclick="btnViewImage_OnClick" />
                                    <input id="Button4" class="btn btn-default" type="button" value="Xoá ảnh" runat="server" onserverclick="btnDelImages_OnClick" />
                                </span>
                                </div>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:CheckBox ID="chkIsSlide" runat="server" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
