<%@ page title="Trình đơn chính" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_Catalog_Main, App_Web_51nukgau" %>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;text-align: center">
                                     ...
                                     <td style="vertical-align:middle;text-align: center">
                                        <asp:CheckBox ID="chkThumb"  Checked='<%# Eval("IsGrid") %>' runat="server" />
                                    </td>
...
<div class="modal fade modal-width-homepage" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-content">
        <div class="modal-header modal-header-background">
            ...
            <h4 class="modal-title modal-titile">Cập nhật trình đơn chính</h4>
        </div>
            ...
            <asp:UpdatePanel ID="UpdatePanelUser" runat="server">
                <ContentTemplate>
                    <asp:Label ID="lbID" runat="server" Text="" Visible="False"></asp:Label>
                        ...
                        <asp:CheckBox ID="chkThumbUpdate" runat="server" Visible="False" />
                </ContentTemplate>
            </asp:UpdatePanel>
            <div class="clr"></div>
        </div>
