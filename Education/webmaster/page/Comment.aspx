<%@ page title="Quản lý bình luận" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_Comment, App_Web_wlb4l3rd" %>
                    ...
                    <div class="col-md-6" style="margin-top: 8px">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="drStatus" CssClass="form-control" runat="server" AutoPostBack="True" AppendDataBoundItems="True" OnSelectedIndexChanged ="drStatus_Change">
                                ...
                                <asp:ListItem Value="0">Chưa xét duyệt</asp:ListItem>
                                <asp:ListItem Value="1">Đã xét duyệt</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-6">
                           ...
                           <asp:Panel ID="PanelSearch" runat="server" DefaultButton="btnSearch">
                               <label class="control-label">Tìm kiếm</label>
                                <div class="input-group">
                                    <input type="text" id="txtSearch" class="form-control search" title="Nhập vào tiêu đề tin tức có dấu hoặc không dấu để tìm kiếm" runat="server">
                ...
                <table class="table table-striped table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center;vertical-align:middle;width: 20%">Tiêu đề</th>
                            <th style="text-align: center;vertical-align:middle;width: 15%">Tên sinh viên</th>
                    ...
                    <asp:ListView ID="ListViewAll" runat="server" DataKeyNames="ID_Comment" ItemPlaceholderID="lstViewAll" OnItemCommand="ListViewAll_ItemCommand" OnItemDataBound="ListViewAll_ItemDataBound">
                        <ItemTemplate>
                            <tbody>
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        ...
                                        <b>Thuộc : </b><asp:Label ID="lb_lst_friendly_url_vn" runat="server" Text='<%# Eval("Catalog_Main_Titile_Vn") %>'></asp:Label> <br/>
                                        <b> »»» </b> <asp:Label ID="lb_lst_titile" runat="server" Text='<%# Eval("Catalog_Prarent_Titile_Vn") %>'></asp:Label>
                                        <input type="hidden" id="hiddenId" value='<%# Eval("ID_Comment") %>' runat="server" name="hiddenId" />
                                    </td>
                                    
                                    <td style="vertical-align:middle;">
                                        <asp:Label ID="lb_lst_titile_en" runat="server" Text='<%# Eval("ID_Student") %>'></asp:Label>
                                    </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-header-background">
                ...
                <h4 class="modal-title modal-titile">Chi tiết bình luận</h4>
            </div>
                ...
                <asp:UpdatePanel ID="UpdatePanelUser" runat="server">
                    <ContentTemplate>
                        <asp:Label ID="lbID" runat="server" Text="" Visible="False"></asp:Label>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Tên người bình luận</label>
                                    <input class="form-control" readonly="readonly" id="txtFullName" runat="server"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Tiêu đề tin tức</label>
                                    <input class="form-control" readonly="readonly" id="txtTitile" runat="server"/>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label" style="text-align:left">Nội dung bình luận</label>
                                    <textarea class="form-control" rows="3" readonly="readonly" id="txtCommentCotent" runat="server"/>
                                </div>
                            </div>
                            <asp:CheckBox ID="chkHideEdit" Text="Xét duyệt" runat="server" />
                    </ContentTemplate>
                    <Triggers>
