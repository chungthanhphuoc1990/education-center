<%@ page title="Nhóm tiện ích" language="C#" masterpagefile="~/webmaster/page/webmaster.master" autoeventwireup="true" inherits="webmaster.page.webmaster_page_Utilities, App_Web_51nukgau" %>
                ...
                <table class="table table-striped table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center;vertical-align:middle;width: 15%">Hình ảnh</th>
                    ...
                    <asp:ListView ID="ListViewAll" runat="server" DataKeyNames="ID_Utilities" ItemPlaceholderID="lstViewAll" OnItemCommand="ListViewAll_ItemCommand" OnItemDataBound="ListViewAll_ItemDataBound">
                        <ItemTemplate>
                            <tbody>
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <b>Tiêu đề : </b><asp:Label ID="lb_lst_titile_vn" runat="server" Text='<%# Eval("Utilities_Titile_Vn") %>'></asp:Label><br/>
                                        ...
                                        <input type="hidden" id="hiddenId" value='<%# Eval("ID_Utilities") %>' runat="server" name="hiddenId" />
                                    </td>
                                    
                                    <td style="vertical-align:middle;">
                                        <b>Tiêu đề : </b> <asp:Label ID="lb_lst_titile_en" runat="server" Text='<%# Eval("Utilities_Titile_En") %>'></asp:Label><br/>
                                        <b>Url : </b> <asp:Label ID="lb_lst_Friendly_Url_En" runat="server" Text='<%# Eval("Friendly_Url_En") %>'></asp:Label>
                                    </td>
                                    
                                     <td style="vertical-align:middle;text-align: center">
                                         <asp:Image ID="lst_images" ImageAlign="Middle" ImageUrl='<%# Eval("Img") %>' Width="120px" Height="120px" runat="server"></asp:Image>
                                     </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-header-background">
                ...
                <h4 class="modal-title modal-titile">Cập nhật nhóm tiện ích</h4>
            </div>
