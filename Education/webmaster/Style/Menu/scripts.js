...
(function(e, t) {
    ...
    b.extend({
        ...
        hasData: function(e) { return e = e.nodeType ? b.cache[e[b.expando]] : e[b.expando], !!e && !$(e); },
    ...
    b.event = {
        ...
        special: {
            load: { noBubble: !0 },
            click: { trigger: function() { return b.nodeName(this, "input") && "checkbox" === this.type && this.click ? (this.click(), !1) : t; } },
            focus: {
                trigger: function() {
        ...
        o = st.getText = function(e) {
            ...
            preFilter: {
                ATTR: function(e) { return e[1] = e[1].replace(et, tt), e[3] = (e[4] || e[5] || "").replace(et, tt), "~=" === e[2] && (e[3] = " " + e[3] + " "), e.slice(0, 4); },
    ...
    b.Tween = rr, rr.prototype = {
        constructor: rr,
        init: function(e, t, n, r, i, o) { this.elem = e, this.prop = n, this.easing = i || "swing", this.options = t, this.start = this.now = this.cur(), this.end = r, this.unit = o || (b.cssNumber[n] ? "" : "px"); },
        cur: function() {
...
(function(e) {
    ...
    function t() {
        if (!n.READY) {
            ...
            n.event.onTouch(document, n.EVENT_MOVE, n.detection.detect), n.event.onTouch(document, n.EVENT_END, n.detection.endDetect), n.READY = !0;
        }
    }

    var n = function(e, t) { return new n.Instance(e, t || {}); };
    ...
    n.STOP_MOUSEEVENTS = n.HAS_TOUCHEVENTS && r.match(/(like mac os x.*mobile.*safari)|android|blackberry/i), n.plugins = {}, n.READY = !1, n.Instance = function(e, r) {
        var i = this;
        return t(), this.element = e, this.enabled = !0, this.options = n.utils.extend(n.utils.extend({}, n.defaults), r || {}), this.options.stop_browser_behavior && n.utils.stopDefaultBrowserBehavior(this), n.event.onTouch(e, n.EVENT_START, function(e) { i.enabled && n.detection.startDetect(i, e); }), this;
        ...
        trigger: function(e, t) {
            ...
            return n.initEvent(e, !0, !0), n.gesture = t, this.element.dispatchEvent(n), this;
        },
        enable: function(e) { return this.enabled = e, this; }
    };
    var i = null, s = !1, o = !1;
    n.event = {
        bindDom: function(e, t, n) { for (var r = t.split(" "), i = 0; r.length > i; i++)e.addEventListener(r[i], n, !1); },
        onTouch: function(e, t, r) {
            var u = this;
            this.bindDom(e, n.EVENT_TYPES[t], function(f) {
                var l = f.type.toLowerCase();
                l.match(/mouse/) && n.STOP_MOUSEEVENTS || (l.match(/start|down|move/) && (1 === f.which || l.match(/touch/) || f.pointerType && f.pointerType == f.MSPOINTER_TYPE_TOUCH) && (s = !0), l.match(/touch|pointer/) && (o = !0), !s || o && l.match(/mouse/) || (n.HAS_POINTEREVENTS && t != n.EVENT_END && n.PointerEvent.updatePointer(t, f), t === n.EVENT_END && null !== i ? f = i : i = f, r.call(n.detection, u.collectEventData(e, t, f)), n.HAS_POINTEREVENTS && t == n.EVENT_END && n.PointerEvent.updatePointer(t, f)), l.match(/up|cancel|end/) && (s = !1, o = !1, i = null, n.PointerEvent.reset()));
            });
        },
        determineEventTypes: function() {
            var e;
            e = n.HAS_POINTEREVENTS ? ["MSPointerDown", "MSPointerMove", "MSPointerUp MSPointerCancel"] : ["touchstart mousedown", "touchmove mousemove", "touchend touchcancel mouseup"], n.EVENT_TYPES[n.EVENT_START] = e[0], n.EVENT_TYPES[n.EVENT_MOVE] = e[1], n.EVENT_TYPES[n.EVENT_END] = e[2];
        },
        getTouchList: function(e) { return n.HAS_POINTEREVENTS ? n.PointerEvent.getTouchList() : e.touches ? e.touches : [{ identifier: 1, pageX: e.pageX, pageY: e.pageY, target: e.target }]; },
        collectEventData: function(e, t, r) {
            var i = this.getTouchList(r, t), s = n.POINTER_TOUCH;
        ...
        getTouchList: function() {
            var e = this.pointers, t = [];
            return Object.keys(e).sort().forEach(function(n) { t.push(e[n]); }), t;
        },
        updatePointer: function(e, t) { e == n.EVENT_END ? delete this.pointers[t.pointerId] : (t.identifier = t.pointerId, this.pointers[t.pointerId] = t); },
        ...
        getVelocity: function(e, t, n) { return{ x: Math.abs(t / e) || 0, y: Math.abs(n / e) || 0 }; },
        getAngle: function(e, t) {
            var n = t.pageY - e.pageY, r = t.pageX - e.pageX;
            return 180 * Math.atan2(n, r) / Math.PI;
        },
        getDirection: function(e, t) {
            var r = Math.abs(e.pageX - t.pageX), i = Math.abs(e.pageY - t.pageY);
            return r >= i ? e.pageX - t.pageX > 0 ? n.DIRECTION_LEFT : n.DIRECTION_RIGHT : e.pageY - t.pageY > 0 ? n.DIRECTION_UP : n.DIRECTION_DOWN;
        },
        getDistance: function(e, t) {
            var n = t.pageX - e.pageX, r = t.pageY - e.pageY;
            return Math.sqrt(n * n + r * r);
        },
        getScale: function(e, t) { return e.length >= 2 && t.length >= 2 ? this.getDistance(t[0], t[1]) / this.getDistance(e[0], e[1]) : 1; },
        getRotation: function(e, t) { return e.length >= 2 && t.length >= 2 ? this.getAngle(t[1], t[0]) - this.getAngle(e[1], e[0]) : 0; },
        isVertical: function(e) { return e == n.DIRECTION_UP || e == n.DIRECTION_DOWN; },
        stopDefaultBrowserBehavior: function(e) {
            var t, n = ["webkit", "khtml", "moz", "ms", "o", ""], r = e.options.stop_browser_behavior, i = e.element;
            if (r && i.style) {
                for (var s = 0; n.length > s; s++)for (var o in r)r.hasOwnProperty(o) && (t = o, n[s] && (t = n[s] + t.substring(0, 1).toUpperCase() + t.substring(1)), i.style[t] = r[o]);
                "none" == r.userSelect && (i.onselectstart = function() { return!1; });
            }
        }
    }, n.detection = {
        gestures: [],
        ...
        previous: null,
        stopped: !1,
        startDetect: function(e, t) { this.current || (this.stopped = !1, this.current = { inst: e, startEvent: n.utils.extend({}, t), lastEvent: !1, name: "" }, this.detect(t)); },
        detect: function(e) {
            if (this.current && !this.stopped) {
                e = this.extendEventData(e);
                for (var t = this.current.inst.options, n = 0, r = this.gestures.length; r > n; n++) {
                    var i = this.gestures[n];
                    if (!this.stopped && t[i.name] !== !1 && i.handler.call(i, e, this.current.inst) === !1) {
                        this.stopDetect();
                        break;
                    }
                }
        ...
        endDetect: function(e) { this.detect(e), this.stopDetect(); },
        ...
        extendEventData: function(e) {
            ...
            if (t && (e.touches.length != t.touches.length || e.touches === t.touches)) {
                t.touches = [];
                for (var r = 0, i = e.touches.length; i > r; r++)t.touches.push(n.utils.extend({}, e.touches[r]));
            }
            var s = e.timestamp - t.timestamp, o = e.center.pageX - t.center.pageX, u = e.center.pageY - t.center.pageY, a = n.utils.getVelocity(s, o, u);
            return n.utils.extend(e, { deltaTime: s, deltaX: o, deltaY: u, velocityX: a.x, velocityY: a.y, distance: n.utils.getDistance(t.center, e.center), angle: n.utils.getAngle(t.center, e.center), direction: n.utils.getDirection(t.center, e.center), scale: n.utils.getScale(t.touches, e.touches), rotation: n.utils.getRotation(t.touches, e.touches), startEvent: t }), e;
        },
        register: function(e) {
            var t = e.defaults || {};
            return t[e.name] === void 0 && (t[e.name] = !0), n.utils.extend(n.defaults, t), e.index = e.index || 1e3, this.gestures.push(e), this.gestures.sort(function(e, t) { return e.index < t.index ? -1 : e.index > t.index ? 1 : 0; }), this.gestures;
        }
        ...
        handler: function(e, t) {
            switch (e.eventType) {
            case n.EVENT_START:
                clearTimeout(this.timer), n.detection.current.name = this.name, this.timer = setTimeout(function() { "hold" == n.detection.current.name && t.trigger("hold", e); }, t.options.hold_timeout);
                break;
            case n.EVENT_MOVE:
        ...
        name: "tap",
        index: 100,
        defaults: { tap_max_touchtime: 250, tap_max_distance: 10, doubletap_distance: 20, doubletap_interval: 300 },
        handler: function(e, t) {
            if (e.eventType == n.EVENT_END) {
                var r = n.detection.previous;
                if (e.deltaTime > t.options.tap_max_touchtime || e.distance > t.options.tap_max_distance)return;
                n.detection.current.name = r && "tap" == r.name && e.timestamp - r.lastEvent.timestamp < t.options.doubletap_interval && e.distance < t.options.doubletap_distance ? "doubletap" : "tap", t.trigger(n.detection.current.name, e);
            }
        }
    }, n.gestures.Swipe = {
        name: "swipe",
        ...
        name: "drag",
        index: 50,
        defaults: { drag_min_distance: 10, drag_max_touches: 1, drag_block_horizontal: !1, drag_block_vertical: !1, drag_lock_to_axis: !1 },
        triggered: !1,
        handler: function(e, t) {
            if (n.detection.current.name != this.name && this.triggered)return t.trigger(this.name + "end", e), this.triggered = !1, void 0;
            if (!(t.options.drag_max_touches > 0 && e.touches.length > t.options.drag_max_touches))
                ...
                case n.EVENT_MOVE:
                    ...
                    t.options.drag_lock_to_axis && r !== e.direction && (e.direction = n.utils.isVertical(r) ? 0 > e.deltaY ? n.DIRECTION_UP : n.DIRECTION_DOWN : 0 > e.deltaX ? n.DIRECTION_LEFT : n.DIRECTION_RIGHT), this.triggered || (t.trigger(this.name + "start", e), this.triggered = !0), t.trigger(this.name, e), t.trigger(this.name + e.direction, e), (t.options.drag_block_vertical && n.utils.isVertical(e.direction) || t.options.drag_block_horizontal && !n.utils.isVertical(e.direction)) && e.preventDefault();
                    break;
                case n.EVENT_END:
        ...
        handler: function(e, t) {
            ...
            if (!(2 > e.touches.length))
                switch (t.options.transform_always_block && e.preventDefault(), e.eventType) {
                case n.EVENT_START:
                    this.triggered = !1;
                    break;
                case n.EVENT_MOVE:
                    var r = Math.abs(1 - e.scale), i = Math.abs(e.rotation);
                    if (t.options.transform_min_scale > r && t.options.transform_min_rotation > i)return;
                    n.detection.current.name = this.name, this.triggered || (t.trigger(this.name + "start", e), this.triggered = !0), t.trigger(this.name, e), i > t.options.transform_min_rotation && t.trigger("rotate", e), r > t.options.transform_min_scale && (t.trigger("pinch", e), t.trigger("pinch" + (1 > e.scale ? "in" : "out"), e));
                    break;
                case n.EVENT_END:
                    this.triggered && t.trigger(this.name + "end", e), this.triggered = !1;
                }
        }
    }, n.gestures.Touch = { name: "touch", index: -1 / 0, defaults: { prevent_default: !1 }, handler: function(e, t) { t.options.prevent_default && e.preventDefault(), e.eventType == n.EVENT_START && t.trigger(this.name, e); } }, n.gestures.Release = { name: "release", index: 1 / 0, handler: function(e, t) { e.eventType == n.EVENT_END && t.trigger(this.name, e); } }, e.Hammer = n, "function" == typeof e.define && e.define.amd && e.define("hammer", [], function() { return n; });
})(window), function(e) {
    Hammer.event.bindDom = function(n, r, i) {
        e(n).on(r, function(e) {
            var t = e.originalEvent;
            t.pageX || (t.pageX = e.pageX, t.pageY = e.pageY), t.target || (t.target = e.target), t.button && (t.which = t.button), t.preventDefault || (t.preventDefault = e.preventDefault), t.stopPropagation || (t.stopPropagation = e.stopPropagation), i.call(this, t);
        });
    }, Hammer.Instance.prototype.on = function(n, r) { return e(this.element).on(n, r); }, Hammer.Instance.prototype.off = function(n, r) { return e(this.element).off(n, r); }, Hammer.Instance.prototype.trigger = function(n, r) { return e(r.srcEvent.target).trigger({ type: n, gesture: r }); }, e.fn.hammer = function(n) {
        return this.each(function() {
            var r = e(this), i = r.data("hammer");
            i ? i && n && Hammer.utils.extend(i.options, n) : r.data("hammer", Hammer(this, n || {}));
        });
    };
}(jQuery);
(function(e) {
    function n() {
        if (e(window).width() <= 768) {
            e(".megamenu").children("li").hide(0);
            e(".megamenu_button").show(0);
            e(".dropdown_flyout .levels").find("ul").css({ left: "0", top: "auto" }).show();
        } else {
            e(".megamenu").children("li").show(0);
            e(".megamenu_button").hide(0);
            e(".dropdown_flyout .levels").find("ul").css({ left: "96%", top: "-23px" }).hide();
            e(".megamenu_vertical_right .dropdown_flyout .levels").find("ul").css({ left: "auto", right: "100%", top: "-23px" }).hide();
        }
        if (e(window).width() > 768 && e(window).width() > 1024) {
            e(".megamenu_vertical_right .dropdown_flyout .levels").find("ul").css({ left: "96%", right: "auto", top: "-23px" }).hide();
        }
    }
    ...
    var t = {
        init: function(t) {
            return this.each(function() {
                var t = e(this), r = e(t).children("li"), i = e(r).children(".menuitem_drop"), s = e(r).find(".dropdown_1column, .dropdown_2columns, .dropdown_3columns, .dropdown_4columns, .dropdown_5columns, .dropdown_fullwidth"), o = e(r).find("li"), u = e(o).find(".parent"), a = e(o).find("ul"), f = e(".megamenu_button");
                menuItemElement = e(r).add(o);
                menuDropDownElement = e(s).add(a);
                if ("ontouchstart" in document.documentElement) {
                    n();
                    e(s).css({ display: "block" }).hide();
                    if (e(window).width() > 768) {
                    }
                    e(f).hammer().on("tap", function() {
                        e(this).toggleClass("megamenu_button_active");
                        e(r).not(":eq(0)").toggle(0);
                    });
                    e(menuItemElement).addClass("noactive").removeClass("active");
                    e(i).hammer().on("tap", function() {
                        var t = e(this);
                        t.parent(r).toggleClass("active noactive").find(s).toggle(0).end().siblings().removeClass("active").addClass("noactive").find(s).hide(0);
                        return false;
                    });
                    e(u).hammer().on("tap", function() {
                        var t = e(this);
                        t.parent(o).toggleClass("active noactive").find(a).first().toggle(0);
                        t.parent(o).siblings().addClass("noactive").removeClass("active").find(a).hide(0);
                        t.parent(o).siblings().find(o).addClass("noactive").removeClass("active");
                        return false;
                    });
                    e(document).hammer().on("tap", function() {
                        e(menuItemElement).addClass("noactive");
                        e(menuDropDownElement).hide(0);
                    });
                    e(t).hammer().on("tap", function(e) { e.stopPropagation(); });
                    e(window).bind("orientationchange", function() {
                        e(menuItemElement).addClass("noactive");
                        e(f).removeClass("megamenu_button_active");
                        e(menuDropDownElement).hide(0);
                        n();
                    });
                    return;
    ...
    e.fn.megaMenuMobile = function(n) {
        if (t[n]) {
            return t[n].apply(this, Array.prototype.slice.call(arguments, 1));
        } else if (typeof n === "object" || !n) {
            return t.init.apply(this, arguments);
        } else {
            e.error("No found method " + n);
        }
    };
})(jQuery);
$(document).ready(function(e) {
    e(".megamenu").megaMenuMobile();
    var t = { target: "#alert" };
    e("#contactForm").ajaxForm(t);
})
/*!
 * jQuery Form Plugin
...
(function(e) {
    ...
    e.fn.ajaxSubmit = function(n) {
        ...
        function N(t) {
            ...
            if (n.extraData) {
                var o = T(n.extraData);
                for (s = 0; s < o.length; s++)if (o[s])i.append(o[s][0], o[s][1]);
            }
            n.data = null;
            var u = e.extend(true, {}, e.ajaxSettings, n, { contentType: false, processData: false, cache: false, type: r || "POST" });
            if (n.uploadProgress) {
                u.xhr = function() {
        ...
        function C(t) {
            ...
            var P = e.parseJSON || function(e) { return window["eval"]("(" + e + ")"); };
        ...
        n = e.extend(true, { url: o, success: e.ajaxSettings.success, type: r || "GET", iframeSrc: /^https/i.test(window.location.href || "") ? "javascript:false" : "about:blank" }, n);
        var a = {};
        ...
        var d = [];
        if (n.resetForm) {
            d.push(function() { u.resetForm(); });
        }
        if (n.clearForm) {
            d.push(function() { u.clearForm(n.includeHidden); });
        }
        ...
        if (n.iframe !== false && (n.iframe || E)) {
            if (n.closeKeepAlive) {
                e.get(n.closeKeepAlive, function() { S = C(h); });
            } else {
                S = C(h);
            }
        } else if ((g || b) && w) {
    ...
    e.fn.ajaxForm = function(t) {
        ...
        if (!t.delegation && this.length === 0) {
            ...
            if (!e.isReady && s.s) {
                ...
                e(function() { e(s.s, s.c).ajaxForm(t); });
                return this;
            }
    ...
    e.fn.formSerialize = function(t) { return e.param(this.formToArray(t)); };
    ...
    e.fn.enable = function(e) {
        ...
        return this.each(function() { this.disabled = !e; });
    };
